...
export function Modal({ isOpen, onClose, title, children, maxWidth = 'md' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${maxWidthClasses[maxWidth]} bg-white dark:bg-gray-800 rounded-2xl shadow-2xl animate-fadeIn max-h-[90vh] overflow-hidden flex flex-col border border-gray-200 dark:border-gray-700`}>
